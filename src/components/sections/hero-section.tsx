    ...
    <section className="relative min-h-[100dvh] flex items-center pt-20 overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute top-0 right-0 bottom-0 w-full md:w-[75%] lg:w-[65%] z-0">
        <Image
          ...
          priority
          quality={100}
          className="object-cover object-[center_top] md:object-[right_top] grayscale opacity-[0.25] contrast-125"
        />
        {/* Shadows for contrast and hiding cutout edges */}
        {/* Top shadow (Stronger on hair) */}
        <div className="absolute inset-x-0 top-0 h-[45%] bg-gradient-to-b from-[#0a0a0a] from-10% via-[#0a0a0a]/70 to-transparent" />
        {/* Bottom shadow */}
        <div className="absolute inset-x-0 bottom-0 h-[40%] bg-gradient-to-t from-[#0a0a0a] from-10% via-[#0a0a0a]/70 to-transparent" />
        {/* Right shadow (Hair/edge on the right) */}
        <div className="absolute inset-y-0 right-0 w-[30%] bg-gradient-to-l from-[#0a0a0a] via-[#0a0a0a]/60 to-transparent" />
        {/* Left shadow */}
        <div className="absolute inset-y-0 left-0 w-[30%] bg-gradient-to-r from-[#0a0a0a] via-[#0a0a0a]/60 to-transparent" />
      </div>

      <Container className="relative z-10 w-full">
        <div className="w-full">
          <MotionWrapper delay={0.1}>
            <h1 className="text-[1.8rem] sm:text-[3.5rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7rem] font-light tracking-[0.15em] text-white uppercase leading-tight mb-8 whitespace-nowrap">
              Arjay Escabas
            </h1>
          </MotionWrapper>
